<?php
    ...
    $not_query = new WP_Query( array( 'posts_per_page' => 3, 'category__not_in' => $category->term_id  ) );
?>
        ...
        <div class="container mt-5">
            ...
            <div class="row mt-5 mb-5">
                ...
                <?php endwhile; else: endif; ?>
                 ...
                 <div class="container mt-5">
            <h1 class="ps-sm-5 pt-sm-4 pb-sm-4 fp-h-b display-1"><?php echo $title3 ?></h1>
            <div class="row mt-5 mb-5">
                <?php 
                // The Loop
                if ( $not_query->have_posts() ) : 
                while( $not_query->have_posts() ) : $not_query->the_post(); ?>
                    <div class="col-md-4 col-small-screen">
                        <a class="text-black" href="<?php echo the_permalink()?>" >
                        <div class="card fp-card card-has-bg click-col" 
                            style="background-image:url(<?php echo get_the_post_thumbnail_url()?>);">
